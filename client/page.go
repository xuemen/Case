...
func pageinit() {
	...
	log.Printf("--- static\\template\\page.yaml:\n%s\n\n", string(pagebyte))
...
func pagetestdata() {
	...
	p1 := page{1, "welcome", "首页", "/", "http://www.processon.com/view/link/551cadf5e4b0f7080ab5e13d", 1, []behavior{b1, b2}, "需要自动检测是否在线，显示正确的内容。\n\r需要自动检测是否有密钥对等信息，显示正确内容。"}
	p2 := page{2, "1.1", "四诊信息", "/record/new", "http://www.processon.com/view/link/551b95bce4b03f4b8f07caec", 1, []behavior{b2, b1}, ""}
